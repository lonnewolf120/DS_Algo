...
unsigned long long nth_even_fib(unsigned long long n)
{
	if(n==0) return 0;
	if(n==1) return 2;
	return ((4*nth_even_fib(n-1))+nth_even_fib(n-2));
}

//using iterative approach to get even fib sum
